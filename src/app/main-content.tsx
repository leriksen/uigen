      ...
      <ChatProvider projectId={project?.id} initialMessages={project?.messages}>
        <div className="h-screen w-screen overflow-hidden bg-neutral-50">
          <ResizablePanelGroup id="main" direction="horizontal" className="h-full">
            ...
            <ResizablePanel id="panel-preview" defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                {/* Top Bar */}
                ...
                <div className="flex-1 overflow-hidden bg-neutral-50">
                  {activeView === "preview" ? (
                    ...
                    >
                      ...
                      <ResizableHandle id="handle-editor" className="w-[1px] bg-neutral-200 hover:bg-neutral-300 transition-colors" />

                      {/* Code Editor */}
                      <ResizablePanel id="panel-code" defaultSize={70}>
                        <div className="h-full bg-white">
                          <CodeEditor />
                        </div>
                      </ResizablePanel>
